...
print(
    "geometricmean:",
    stats.geometricmean(l),
    stats.geometricmean(lf),
    stats.geometricmean(a),
    stats.geometricmean(af),
)
print(
    "harmonicmean:",
    stats.harmonicmean(l),
    stats.harmonicmean(lf),
    stats.harmonicmean(a),
    stats.harmonicmean(af),
)
...
print(
    "medianscore:",
    stats.medianscore(l),
    stats.medianscore(lf),
    stats.medianscore(a),
    stats.medianscore(af),
)
...
print(
    "scoreatpercentile:",
    stats.scoreatpercentile(l, 40),
    stats.scoreatpercentile(lf, 40),
    stats.scoreatpercentile(a, 40),
    stats.scoreatpercentile(af, 40),
)
print(
    "percentileofscore:",
    stats.percentileofscore(l, 12),
    stats.percentileofscore(lf, 12),
    stats.percentileofscore(a, 12),
...
print("\nTRIMMING")
print("trimboth:")
print(stats.trimboth(l, 0.2))
print(stats.trimboth(lf, 0.2))
print(stats.trimboth(a, 0.2))
print(stats.trimboth(af, 0.2))
print("trim1:")
print(stats.trim1(l, 0.2))
print(stats.trim1(lf, 0.2))
print(stats.trim1(a, 0.2))
print(stats.trim1(af, 0.2))
print("\nCORRELATION")
...
print(
    "sumsquared:",
    stats.square_of_sums(l),
    stats.square_of_sums(lf),
    stats.square_of_sums(a),
    stats.square_of_sums(af),
)
print(
    "sumdiffsquared:",
    stats.sumdiffsquared(l, m),
    stats.sumdiffsquared(lf, m),
    stats.sumdiffsquared(a, b),
