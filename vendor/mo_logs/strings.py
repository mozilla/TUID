...
def toString(val):
    ...
    if val == None:
        ...
        try:
            ...
            _Log.error(
                text_type(type(val)) + " type can not be converted to unicode", cause=e
            )
    else:
        try:
...
def utf82unicode(value):
    ...
    try:
        ...
        _Log.error(
            "Can not explain conversion failure of " + type(value).__name__ + "!", e
        )
